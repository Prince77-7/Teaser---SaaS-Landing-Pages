      ...
      <div className="flex flex-row justify-between items-center">
        ...
        <div className="lg:flex hidden w-[35%] items-center justify-end">
          ...
          <a 
            ...
            className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white transition-colors duration-300 bg-blue-600 rounded-md shadow hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-black"
          >
            Book Consultation
          </a>
