    ...
    <ComponentTransition className="h-auto max-w-[1500px] px-10 xl:px-20 pb-20">
      ...
      <div className="flex justify-center items-center flex-col">
        <p className="text-base md:text-2xl text-neutral-500 md:w-[70%] text-center">
          Learn about our commitment to helping individuals and families navigate the complexities of credit repair and achieve their financial goals.
        </p>
      </div>
      <CardAbout />
      <Feedback className='!px-0' />
      <CardOffer title='Start Your Credit Journey Today' className="!px-0" />
    </ComponentTransition>
  );
};
