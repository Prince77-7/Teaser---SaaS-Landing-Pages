  ...
  return (
    <div className="h-auto max-w-[1500px] flex flex-col items-center justify-center mt-20 max-md:px-5 px-10 xl:px-20 pb-10 overflow-hidden">
      <div className="flex justify-center mt-20 relative">
        <h1 className="text-4xl md:text-5xl lg:text-[4.5rem] text-center py-5 leading-tight lg:leading-[60px] bg-clip-text dark:bg-gradient-to-r from-white from-50% to-black bg-text w-[90%] md:w-[70%] text-transparent font-bold">
          {blog.bigTitle}
        </h1>
