    ...
    <ComponentTransition className="h-auto max-w-[1500px] px-10 xl:px-20 pb-20">
      <div className="flex justify-center py-5 ">
        <div className="flex justify-center mt-20 relative ">
          ...
          Our Comprehensive Credit Solution
          </h1>
      ...
      <div className="flex justify-center items-center flex-col">
        ...
        Empowerment Consulting Services offers a multi-faceted approach to address your credit challenges and build a stronger financial foundation.
        </p>
      </div>
